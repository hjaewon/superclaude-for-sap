...
// The [1m] suffix in model IDs (e.g. `claude-opus-4-8[1m]`) is transparently handled
// by startsWith() — the entry matches regardless of whether the 1M indicator is present.
export const PRICING = {
  'claude-opus-4-8':    { input: 5,  output: 25, cacheWrite: 6.25,  cacheRead: 0.5,  ctx: 1_000_000 },
  'claude-opus-4-7':    { input: 5,  output: 25, cacheWrite: 6.25,  cacheRead: 0.5,  ctx: 1_000_000 },
  'claude-opus-4-6':    { input: 5,  output: 25, cacheWrite: 6.25,  cacheRead: 0.5,  ctx: 1_000_000 },
